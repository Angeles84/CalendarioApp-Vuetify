        ...
        >
          ...
          >
            ...
            <v-card-actions>
              ...
              <v-btn text outlined color="amber accent-3" v-if="currentlyEditing !== selectedEvent.id"
              @click.prevent="editEvent(selectedEvent.id)">Editar</v-btn>

              <v-btn text outlined color="light-green darken-1" v-else @click.prevent="updateEvent(selectedEvent)">Guardar Cambios</v-btn>
            </v-card-actions>
          </v-card>
        </v-menu>
      </v-sheet>
